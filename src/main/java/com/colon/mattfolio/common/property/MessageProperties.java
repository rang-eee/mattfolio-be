package com.colon.mattfolio.common.property;
...
public class MessageProperties {
	...
	public static void setMessageSourceAccessor(MessageSourceAccessor messageSourceAccessor) {
		MessageProperties.messageSourceAccessor = messageSourceAccessor;
	}
	...
	public static String getMessage(String messageCode) {
		return MessageProperties.messageSourceAccessor.getMessage(messageCode, messageCode);
	}
	...
	public static String getMessage(String messageCode, Locale locale) {
		return MessageProperties.messageSourceAccessor.getMessage(messageCode, messageCode, locale);
	}
	...
	public static String getMessage(String messageCode, Object... args) {
		return MessageProperties.messageSourceAccessor.getMessage(messageCode, args, messageCode);
	}
	...
	public static String getMessage(String messageCode, Locale locale, Object... args) {
		return MessageProperties.messageSourceAccessor.getMessage(messageCode, args, messageCode, locale);
	}
}