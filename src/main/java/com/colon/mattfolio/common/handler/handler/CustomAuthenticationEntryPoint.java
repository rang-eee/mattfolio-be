...
/**
 * CustomAuthenticationEntryPoint는 인증 실패 시 실행되어 클라이언트에게 커스텀 에러 응답을 반환하는 역할을 합니다. 이 클래스는 AuthenticationEntryPoint 인터페이스를 구현하여, 인증되지 않은 사용자에 대해 JSON 형식의 에러 메시지를 반환합니다.
 */
